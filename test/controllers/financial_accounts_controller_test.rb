...
class FinancialAccountsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create financial_account" do
    assert_difference("FinancialAccount.count") do
      post financial_accounts_url, params: { financial_account: { account_name: @financial_account.account_name, account_number: @financial_account.account_number, agency: @financial_account.agency, bank: @financial_account.bank, description: @financial_account.description } }
    end
  ...
  test "should update financial_account" do
    patch financial_account_url(@financial_account), params: { financial_account: { account_name: @financial_account.account_name, account_number: @financial_account.account_number, agency: @financial_account.agency, bank: @financial_account.bank, description: @financial_account.description } }
