...
class PaymentMethodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create payment_method" do
    assert_difference("PaymentMethod.count") do
      post payment_methods_url, params: { payment_method: { financial_account_id: @payment_method.financial_account_id, name: @payment_method.name, rate: @payment_method.rate } }
    end
  ...
  test "should update payment_method" do
    patch payment_method_url(@payment_method), params: { payment_method: { financial_account_id: @payment_method.financial_account_id, name: @payment_method.name, rate: @payment_method.rate } }
