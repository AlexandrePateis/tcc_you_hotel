...
class HotelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hotel" do
    assert_difference("Hotel.count") do
      post hotels_url, params: { hotel: { cnpj: @hotel.cnpj, manager: @hotel.manager, name: @hotel.name, phone: @hotel.phone } }
    end
  ...
  test "should update hotel" do
    patch hotel_url(@hotel), params: { hotel: { cnpj: @hotel.cnpj, manager: @hotel.manager, name: @hotel.name, phone: @hotel.phone } }
